...
function IndexPage() {
  return (
    ...
    <div>
      ...
      <div class="main">
      <h1>Bienvenidos a nuestra página de nutrición, donde promovemos un estilo de vida saludable a través de la alimentación balanceada y la actividad física.</h1> <br/> 
